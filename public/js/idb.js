...
let db;
// establish a connection to the IndexedDB database called 'budget_tracker' and set it to version 1
...
request.onsuccess = function(event) {
    // when db is successfully created with its object store (from on upgradedneeded event above) or simply established a connection, save reference to db in global variable
